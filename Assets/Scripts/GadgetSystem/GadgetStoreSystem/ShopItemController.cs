...
//                _gadgetInstance = _gadgetService.CreateGadget(_data, transform.position, transform).gameObject;
//                _gadgetInstance.transform.localPosition = Vector3.zero;
//                _gadgetInstance.SetActive(false);

//                GameObjectInjector.InjectObject(_gadgetInstance, _container);
...
//                if (_gadgetInstance.TryGetComponent<GadgetView>(out var gadget))
//                {
//                    GadgetModel _gadgetModel = new GadgetModel(_data, _store);
//                //    gadget._storeManager = _store; // //TODO: VERY BAD!!!! Should be easily fiable with proper injector.
//                    gadget.Initialize(_gadgetModel);
